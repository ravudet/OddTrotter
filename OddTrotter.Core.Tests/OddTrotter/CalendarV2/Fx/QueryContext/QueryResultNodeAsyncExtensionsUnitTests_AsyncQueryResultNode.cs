...
#pragma warning restore CS8600 // Converting null literal or possible null value to non-nullable type.
        ...
        [TestMethod]
        public async Task TrySelectFutureNodeNullSource()
        {
            ITask<IQueryResultNodeAsync<string, Exception>> source =
#pragma warning disable CS8600 // Converting null literal or possible null value to non-nullable type.
                null
#pragma warning restore CS8600 // Converting null literal or possible null value to non-nullable type.
                ;
...
#pragma warning restore CS8604 // Possible null reference argument.
        ...
        [TestMethod]
        public async Task TrySelectFutureNodeNullTry()
        {
            var source = 
                new[] { "asdf", "42", "67", "qwer" }
                    .ToQueryResultAsync()
...
#pragma warning restore CS8625 // Cannot convert null literal to non-nullable reference type.
        ...
        [TestMethod]
        public async Task TrySelectFutureNodeWithoutError()
        {
            var source = 
                new[] { "asdf", "42", "67", "qwer" }
                    .ToQueryResultAsync()
        ...
        [TestMethod]
        public async Task TrySelectFutureNodeWithError()
        {
            var invalidOperationException = new InvalidOperationException();
            var source = 
                new[] { "asdf", "42", "67", "qwer" }
...
#pragma warning restore CS8604 // Possible null reference argument.
        ...
        [TestMethod]
        public async Task WhereFutureNodeNullPredicate()
        {
            var value = "asdf";
            var node = CreateNodeWithElementAsync(value);
...
#pragma warning restore CS8625 // Cannot convert null literal to non-nullable reference type.
        ...
        [TestMethod]
        public async Task WhereFutureNodeNoElements()
        {
            var node = CreateNodeWithNoElementsAsync();
        ...
        [TestMethod]
        public async Task WhereFutureNodeNoElementsError()
        {
            var invalidOperationException = new InvalidOperationException();
            var node = CreateNodeWithErrorAsync(invalidOperationException);
        ...
        [TestMethod]
        public async Task WhereFutureNodeNoError()
        {
            var value = "asdf";
            var node = CreateNodeWithElementAsync(value);
        ...
        [TestMethod]
        public async Task WhereFutureNodeElementFollowedByError()
        {
            var value = "asdf";
            var invalidOperationException = new InvalidOperationException();
            var node = CreateNodeWithElementThenErrorAsync(value, invalidOperationException);
