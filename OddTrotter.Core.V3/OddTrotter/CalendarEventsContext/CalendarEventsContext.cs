namespace OddTrotter.CalendarEventsContext
{
            ...
            >
    {
        ...
        private sealed class QueryResult : 
            IQueryResult<IEither<CalendarEvent, CalendarEventTranslationException>, PagingException>,
        {
            private readonly Graph.ICalendarSource calendarSource;
            private readonly DateTime startTime; //// TODO should you also add this to settings, defaulting to `now`?
            private readonly uint pageSize;
            ...
            public IQueryResultNode<IEither<CalendarEvent, CalendarEventTranslationException>, PagingException> Nodes
            {
                get
                {
            ...
            private sealed class QueryResultNode : IQueryResultNode<IEither<CalendarEvent, CalendarEventTranslationException>, PagingException>
            {
                private readonly Graph.ICalendarSource calendarSource;
                private readonly DateTime startTime; //// TODO should you also add this to settings, defaulting to `now`?
                private readonly uint pageSize;
                ...
                public Realizable<TResult> ApplyAsync<TResult, TContext, TContinuable>(AsyncRefContextualizedContinuableMap<IElement<IEither<CalendarEvent, CalendarEventTranslationException>, PagingException>, TContext, TContinuable, TResult> leftMap, AsyncRefContextualizedContinuableMap<IEither<IError<PagingException>, IEmpty>, TContext, TContinuable, TResult> rightMap, ref TContext context)
