...
namespace Fx.Either
{
    ...
    public static class EitherExtensions
    {
        ...
        public static Realizable<TResult> ApplyAsync2<TLeft, TRight, TResult>(
            ...
            where TResult : allows ref struct
        {
            return either.ApplyAsync2<IEither<TLeft, TRight>, TLeft, TRight, TResult>(leftMap, rightMap);
        }
        ...
        public static Realizable<TResult> ApplyAsync2<TLeft, TRight, TResult>(
            ...
            where TResult : allows ref struct
        {
            return either.TypeHolder().ApplyAsync2(leftMap, rightMap);
        }
        ...
        public static Realizable<TResult> ApplyAsync2<TEither, TLeft, TRight, TResult>(
            ...
            where TResult : allows ref struct
        {
            return either.Self.ApplyAsync2(leftMap, rightMap);
        }
        ...
        public static Realizable<TResult> ApplyAsync2<TEither, TLeft, TRight, TResult>(
            ...
            where TResult : allows ref struct
        {
            return either.ApplyAsync2<TEither, TLeft, TRight, Realizable<TResult>, TResult>(
                leftMap,
                rightMap);
        }
        ...
        public static Realizable<TResult> ApplyAsync2<TEither, TLeft, TRight, TResult>(
            ...
            where TResult : allows ref struct
        {
            return either.ApplyAsync2<TEither, TLeft, TRight, IContinuable<TResult>, TResult>(
                leftMap,
                rightMap);
        }

        public static Realizable<TResult> ApplyAsync2<TLeft, TRight, TContinuable, TResult>(
            this Realizable<IEither<TLeft, TRight>> either,
            Func<TLeft, TContinuable> leftMap,
            Func<TRight, TContinuable> rightMap)
            where TLeft : allows ref struct
            ...
            where TResult : allows ref struct
        {
            return either.ApplyAsync2<IEither<TLeft, TRight>, TLeft, TRight, TContinuable, TResult>(leftMap, rightMap);
        }

        public static Realizable<TResult> ApplyAsync2<TEither, TLeft, TRight, TContinuable, TResult>(
            this Realizable<TypeHolder<TEither, TLeft, TRight>> realizable,
            Func<TLeft, TContinuable> leftMap,
            Func<TRight, TContinuable> rightMap)
            where TEither : IEither<TLeft, TRight>, allows ref struct
        ...
        {
            return FromTypeHolder(realizable)
                .ApplyAsync2<TEither, TLeft, TRight, TContinuable, TResult>(
                    leftMap, rightMap);
        }
        ...
        public static Realizable<TResult> ApplyAsync2<TEither, TLeft, TRight, TContinuable, TResult>(
            ...
            where TResult : allows ref struct
        {
            return either.Self.ApplyAsync2<TEither, TLeft, TRight, TContinuable, TResult>(leftMap, rightMap);
        }
