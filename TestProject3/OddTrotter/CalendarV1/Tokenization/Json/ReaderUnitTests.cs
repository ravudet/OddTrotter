...
""";
        ...
        public static async Task StaticOnlyFullRead(Stream stream)
        {
            ...
            (context, var valueReader) = await whitespaceReader.MoveTry2(context).ConfigureAwait(false);
            ...
            (context, var membersReader) = whitespacereader2.MoveTry2(context).ConfigureAwait(false);
            var membersToken = membersReader.MoveTry3(context).ConfigureAwait(false);
            Assert.IsTrue(membersToken.TrySome(out var firstMemberReader));

            // true
            var memberReader = firstMemberReader.MoveTry1(context).ConfigureAwait(false);
            var stringReader = memberReader.MoveTry1(context).ConfigureAwait(false);
            var stringDelimiterReader = stringReader.MoveTry1(context).ConfigureAwait(false);
            var charsReader = stringDelimiterReader.MoveTry4(context).ConfigureAwait(false);
            (context, var stringDelimiterReader2) = charsReader.MoveTry2(context).ConfigureAwait(false);
            var whitespaceReader3 = stringDelimiterReader2.MoveTry4(context).ConfigureAwait(false);
            (context, var colonReader) = whitespaceReader3.MoveTry2(context).ConfigureAwait(false);
            var whitespaceReader4 = colonReader.MoveTry4(context).ConfigureAwait(false);
            (context, var valueReader2) = whitespaceReader4.MoveTry2(context).ConfigureAwait(false);
            var valueToken2 = valueReader2.MoveTry3(context).ConfigureAwait(false);
            Assert.IsTrue(valueToken2.TryTrue(out var @true));
            (context, var subsequentMembersReader) = @true.MoveTry2(context).ConfigureAwait(false);
            var subsequentMembersToken = subsequentMembersReader.MoveTry3(context).ConfigureAwait(false);
            Assert.IsTrue(subsequentMembersToken.TryMore(out var subsequentMemberReader));
            var commaReader = subsequentMemberReader.MoveTry1(context).ConfigureAwait(false);
            var whitespaceReader5 = commaReader.MoveTry4(context).ConfigureAwait(false);

            // false
            (context, var memberReader2) = whitespaceReader5.MoveTry2(context).ConfigureAwait(false);
            var stringReader2 = memberReader2.MoveTry1(context).ConfigureAwait(false);
            var stringDelimterReader3 = stringReader2.MoveTry1(context).ConfigureAwait(false);
            var charsReader2 = stringDelimterReader3.MoveTry4(context).ConfigureAwait(false);
            (context, var stringDelimiterReader4) = charsReader2.MoveTry2(context).ConfigureAwait(false);
            var whitespace6 = stringDelimiterReader4.MoveTry4(context).ConfigureAwait(false);
            (context, var colon2) = whitespace6.MoveTry2(context).ConfigureAwait(false);
            var whitespace7 = colon2.MoveTry4(context).ConfigureAwait(false);
            (context, var value3) = whitespace7.MoveTry2(context).ConfigureAwait(false);
            var valueToken3 = value3.MoveTry3(context).ConfigureAwait(false);
            Assert.IsTrue(valueToken3.TryFalse(out var @false));
            (context, var subsequentMembers2) = @false.MoveTry2(context).ConfigureAwait(false);
            var subsequentMembersToken2 = subsequentMembers2.MoveTry3(context).ConfigureAwait(false);
            Assert.IsTrue(subsequentMembersToken2.TryMore(out var subsequentMember2));

            // 1234
            var comma2 = subsequentMember2.MoveTry1(context).ConfigureAwait(false);
            var whitespace8 = comma2.MoveTry4(context).ConfigureAwait(false);
            (context, var member3) = whitespace8.MoveTry2(context).ConfigureAwait(false);
            var string3 = member3.MoveTry1(context).ConfigureAwait(false);
            var stringDelimiter5 = string3.MoveTry1(context).ConfigureAwait(false);
            var chars3 = stringDelimiter5.MoveTry4(context).ConfigureAwait(false);
            (context, var stringDelimiter6) = chars3.MoveTry2(context).ConfigureAwait(false);
            var whitespace9 = stringDelimiter6.MoveTry4(context).ConfigureAwait(false);
            (context, var colon3) = whitespace9.MoveTry2(context).ConfigureAwait(false);
            var whitespace10 = colon3.MoveTry4(context).ConfigureAwait(false);
            (context, var value4) = whitespace10.MoveTry2(context).ConfigureAwait(false);
            var valueToken4 = value4.MoveTry3(context).ConfigureAwait(false);
            Assert.IsTrue(valueToken4.TryNumber(out var number));
            var sign = number.MoveTry1(context).ConfigureAwait(false);
            var @int = sign.MoveTry4(context).ConfigureAwait(false);
            (context, var frac) = @int.MoveTry2(context).ConfigureAwait(false);
            var fracToken = frac.MoveTry3(context).ConfigureAwait(false);
            Assert.IsTrue(fracToken.TryAbsent(out var exp));
            var expToken = exp.MoveTry3(context).ConfigureAwait(false);
            Assert.IsTrue(expToken.TryAbsent(out var subsequentMembers3));
            var subsequentMembersToken3 = subsequentMembers3.MoveTry3(context).ConfigureAwait(false);
            Assert.IsTrue(subsequentMembersToken3.TryMore(out var subsequentMember3));

            // asdf
            var comma3 = subsequentMember3.MoveTry1(context).ConfigureAwait(false);
            var whitespace11 = comma3.MoveTry4(context).ConfigureAwait(false);
            (context, var member4) = whitespace11.MoveTry2(context).ConfigureAwait(false);
            var string4 = member4.MoveTry1(context).ConfigureAwait(false);
            var stringDelimiter7 = string4.MoveTry1(context).ConfigureAwait(false);
            var chars4 = stringDelimiter7.MoveTry4(context).ConfigureAwait(false);
            (context, var stringDelimiter8) = chars4.MoveTry2(context).ConfigureAwait(false);
            var whitespace12 = stringDelimiter8.MoveTry4(context).ConfigureAwait(false);
            (context, var colon4) = whitespace12.MoveTry2(context).ConfigureAwait(false);
            var whitespace13 = colon4.MoveTry4(context).ConfigureAwait(false);
            (context, var value5) = whitespace13.MoveTry2(context).ConfigureAwait(false);
            var valueToken5 = value5.MoveTry3(context).ConfigureAwait(false);
            Assert.IsTrue(valueToken5.TryString(out var @string5));
            var stringDelimiter9 = string5.MoveTry1(context).ConfigureAwait(false);
            var chars5 = stringDelimiter9.MoveTry4(context).ConfigureAwait(false);
            (context, var stringDelimiter10) = chars5.MoveTry2(context).ConfigureAwait(false);
            var subsequentMembers4 = stringDelimiter10.MoveTry4(context).ConfigureAwait(false);
            var subsequentMembersToken4 = subsequentMembers4.MoveTry3(context).ConfigureAwait(false);
            Assert.IsTrue(subsequentMembersToken4.TryMore(out var subsequentMember4));

            // null
            var comma4 = subsequentMember4.MoveTry1(context).ConfigureAwait(false);
            var whitespace14 = comma4.MoveTry4(context).ConfigureAwait(false);
            (context, var member5) = whitespace14.MoveTry2(context).ConfigureAwait(false);
            var string6 = member5.MoveTry1(context).ConfigureAwait(false);
            var stringDelimiter11 = string6.MoveTry1(context).ConfigureAwait(false);
            var chars6 = stringDelimiter11.MoveTry4(context).ConfigureAwait(false);
            (context, var stringDelimiter12) = chars6.MoveTry2(context).ConfigureAwait(false);
            var whitespace15 = stringDelimiter12.MoveTry4(context).ConfigureAwait(false);
            (context, var colon5) = whitespace15.MoveTry2(context).ConfigureAwait(false);
            var whitespace16 = colon5.MoveTry4(context).ConfigureAwait(false);
            (context, var value6) = whitespace16.MoveTry2(context).ConfigureAwait(false);
            var valueToken6 = value6.MoveTry3(context).ConfigureAwait(false);
            Assert.IsTrue(valueToken6.TryNull(out var @null));
            (context, var subsequentMembers5) = @null.MoveTry2(context).ConfigureAwait(false);
            var subsequentMembersToken5 = subsequentMembers5.MoveTry3(context).ConfigureAwait(false);
            Assert.IsTrue(subsequentMembersToken5.TryMore(out var subsequentMember5));


            // object
            var comma5 = subsequentMember5.MoveTry1(context).ConfigureAwait(false);
            var whitespace17 = comma5.MoveTry4(context).ConfigureAwait(false);
            (context, var member6) = whitespace17.MoveTry2(context).ConfigureAwait(false);
            var string7 = member6.MoveTry1(context).ConfigureAwait(false);
            var stringDelimiter13 = string7.MoveTry1(context).ConfigureAwait(false);
            var chars7 = stringDelimiter13.MoveTry4(context).ConfigureAwait(false);
            (context, var stringDelimiter14) = chars7.MoveTry2(context).ConfigureAwait(false);
            var whitespace18 = stringDelimiter14.MoveTry4(context).ConfigureAwait(false);
            (context, var colon6) = whitespace18.MoveTry2(context).ConfigureAwait(false);
            var whitespace19 = colon6.MoveTry4(context).ConfigureAwait(false);
            (context, var value7) = whitespace19.MoveTry2(context).ConfigureAwait(false);
            var valueToken7 = value7.MoveTry3(context).ConfigureAwait(false);
            Assert.IsTrue(valueToken7.TryObject(out var object2));
            var objectStart2 = object2.MoveTry1(context).ConfigureAwait(false);
            var whitespace20 = objectStart2.MoveTry4(context).ConfigureAwait(false);
            (context, var nestedMembers) = whitespace20.MoveTry2(context).ConfigureAwait(false);
            var nestedMembersToken = nestedMembers.MoveTry3(context).ConfigureAwait(false);
            ...
            {
                // true
                var nestedMember = nestedFirstMember.MoveTry1(context).ConfigureAwait(false);
                var nestedString = nestedMember.MoveTry1(context).ConfigureAwait(false);
                var nestedStringDelimiter = nestedString.MoveTry1(context).ConfigureAwait(false);
                var nestedChars = nestedStringDelimiter.MoveTry4(context).ConfigureAwait(false);
                (context, var nestedStringDeliminter2) = nestedChars.MoveTry2(context).ConfigureAwait(false);
                var nestedWhitespace = nestedStringDeliminter2.MoveTry4(context).ConfigureAwait(false);
                (context, var nestedColon) = nestedWhitespace.MoveTry2(context).ConfigureAwait(false);
                var nestedWhispace2 = nestedColon.MoveTry4(context).ConfigureAwait(false);
                (context, var nestedValue) = nestedWhispace2.MoveTry2(context).ConfigureAwait(false);
                var nestedValueToken = nestedValue.MoveTry3(context).ConfigureAwait(false);
                Assert.IsTrue(nestedValueToken.TryTrue(out var nestedTrue));
                (context, var nestedSubsequentMembersReader) = nestedTrue.MoveTry2(context).ConfigureAwait(false);
                var nestedSubsequentMembersToken = nestedSubsequentMembersReader.MoveTry3(context).ConfigureAwait(false);
                Assert.IsTrue(nestedSubsequentMembersToken.TryMore(out var nestedsubsequentMemberReader));

                // false
                var nestedcommaReader = nestedsubsequentMemberReader.MoveTry1(context).ConfigureAwait(false);
                var nestedwhitespaceReader5 = nestedcommaReader.MoveTry4(context).ConfigureAwait(false);
                (context, var nestedmemberReader2) = nestedwhitespaceReader5.MoveTry2(context).ConfigureAwait(false);
                var nestedstringReader2 = nestedmemberReader2.MoveTry1(context).ConfigureAwait(false);
                var nestedstringDelimiterReader3 = nestedstringReader2.MoveTry1(context).ConfigureAwait(false);
                var nestedcharsReader2 = nestedstringDelimiterReader3.MoveTry4(context).ConfigureAwait(false);
                (context, var nestedstringDelimiterReader4) = nestedcharsReader2.MoveTry2(context).ConfigureAwait(false);
                var nestedwhitespace6 = nestedstringDelimiterReader4.MoveTry4(context).ConfigureAwait(false);
                (context, var nestedcolon2) = nestedwhitespace6.MoveTry2(context).ConfigureAwait(false);
                var nestedwhitespace7 = nestedcolon2.MoveTry4(context).ConfigureAwait(false);
                (context, var nestedvalue3) = nestedwhitespace7.MoveTry2(context).ConfigureAwait(false);
                var nestedvalueToken3 = nestedvalue3.MoveTry3(context).ConfigureAwait(false);
                Assert.IsTrue(nestedvalueToken3.TryFalse(out var nestedfalse));

                (context, var nestedsubsequentMembers2) = nestedfalse.MoveTry2(context).ConfigureAwait(false);
                var nestedsubsequentMembersToken2 = nestedsubsequentMembers2.MoveTry3(context).ConfigureAwait(false);
                Assert.IsTrue(nestedsubsequentMembersToken2.TryMore(out var nestedsubsequentMember2));

                // 1234
                var nestedcomma2 = nestedsubsequentMember2.MoveTry1(context).ConfigureAwait(false);
                var nestedwhitespace8 = nestedcomma2.MoveTry4(context).ConfigureAwait(false);
                (context, var nestedmember3) = nestedwhitespace8.MoveTry2(context).ConfigureAwait(false);
                var nestedstring3 = nestedmember3.MoveTry1(context).ConfigureAwait(false);
                var nestedstringDelimiter5 = nestedstring3.MoveTry1(context).ConfigureAwait(false);
                var nestedchars3 = nestedstringDelimiter5.MoveTry4(context).ConfigureAwait(false);
                (context, var nestedstringDelimiter6) = nestedchars3.MoveTry2(context).ConfigureAwait(false);
                var nestedwhitespace9 = nestedstringDelimiter6.MoveTry4(context).ConfigureAwait(false);
                (context, var nestedcolon3) = nestedwhitespace9.MoveTry2(context).ConfigureAwait(false);
                var nestedwhitespace10 = nestedcolon3.MoveTry4(context).ConfigureAwait(false);
                (context, var nestedvalue4) = nestedwhitespace10.MoveTry2(context).ConfigureAwait(false);
                var nestedvalueToken4 = nestedvalue4.MoveTry3(context).ConfigureAwait(false);
                Assert.IsTrue(nestedvalueToken4.TryNumber(out var nestednumber));
                var nestedsign = nestednumber.MoveTry1(context).ConfigureAwait(false);
                var nestedint = nestedsign.MoveTry4(context).ConfigureAwait(false);
                (context, var nestedfrac) = nestedint.MoveTry2(context).ConfigureAwait(false);
                var nestedfracToken = nestedfrac.MoveTry3(context).ConfigureAwait(false);
                Assert.IsTrue(nestedfracToken.TryAbsent(out var nestedexp));
                var nestedexpToken = nestedexp.MoveTry3(context).ConfigureAwait(false);
                Assert.IsTrue(nestedexpToken.TryAbsent(out var nestedsubsequentMembers3));
                var nestedsubsequentMembersToken3 = nestedsubsequentMembers3.MoveTry3(context).ConfigureAwait(false);
                Assert.IsTrue(nestedsubsequentMembersToken3.TryMore(out var nestedsubsequentMember3));

                // asdf
                var nestedcomma3 = nestedsubsequentMember3.MoveTry1(context).ConfigureAwait(false);
                var nestedwhitespace11 = nestedcomma3.MoveTry4(context).ConfigureAwait(false);
                (context, var nestedmember4) = nestedwhitespace11.MoveTry2(context).ConfigureAwait(false);
                var nestedstring4 = nestedmember4.MoveTry1(context).ConfigureAwait(false);
                var nestedstringDelimiter7 = nestedstring4.MoveTry1(context).ConfigureAwait(false);
                var nestedchars4 = nestedstringDelimiter7.MoveTry4(context).ConfigureAwait(false);
                (context, var nestedstringDelimiter8) = nestedchars4.MoveTry2(context).ConfigureAwait(false);
                var nestedwhitespace12 = nestedstringDelimiter8.MoveTry4(context).ConfigureAwait(false);
                (context, var nestedcolon4) = nestedwhitespace12.MoveTry2(context).ConfigureAwait(false);
                var nestedwhitespace13 = nestedcolon4.MoveTry4(context).ConfigureAwait(false);
                (context, var nestedvalue5) = nestedwhitespace13.MoveTry2(context).ConfigureAwait(false);
                var nestedvalueToken5 = nestedvalue5.MoveTry3(context).ConfigureAwait(false);
                Assert.IsTrue(nestedvalueToken5.TryString(out var nestedstring5));
                var nestedstringDelimiter9 = @nestedstring5.MoveTry1(context).ConfigureAwait(false);
                var nestedchars5 = nestedstringDelimiter9.MoveTry4(context).ConfigureAwait(false);
                (context, var nestedstringDelimiter10) = nestedchars5.MoveTry2(context).ConfigureAwait(false);
                var nestedsubsequentMembers4 = nestedstringDelimiter10.MoveTry4(context).ConfigureAwait(false);
                var nestedsubsequentMembersToken4 = nestedsubsequentMembers4.MoveTry3(context).ConfigureAwait(false);
                Assert.IsTrue(nestedsubsequentMembersToken4.TryMore(out var nestedsubsequentMember4));

                // null
                var nestedcomma4 = nestedsubsequentMember4.MoveTry1(context).ConfigureAwait(false);
                var nestedwhitespace14 = nestedcomma4.MoveTry4(context).ConfigureAwait(false);
                (context, var nestedmember5) = nestedwhitespace14.MoveTry2(context).ConfigureAwait(false);
                var nestedstring6 = nestedmember5.MoveTry1(context).ConfigureAwait(false);
                var nestedstringDelimiter11 = nestedstring6.MoveTry1(context).ConfigureAwait(false);
                var nestedchars6 = nestedstringDelimiter11.MoveTry4(context).ConfigureAwait(false);
                (context, var nestedstringDelimiter12) = nestedchars6.MoveTry2(context).ConfigureAwait(false);
                var nestedwhitespace15 = nestedstringDelimiter12.MoveTry4(context).ConfigureAwait(false);
                (context, var nestedcolon5) = nestedwhitespace15.MoveTry2(context).ConfigureAwait(false);
                var nestedwhitespace16 = nestedcolon5.MoveTry4(context).ConfigureAwait(false);
                (context, var nestedvalue6) = nestedwhitespace16.MoveTry2(context).ConfigureAwait(false);
                var nestedvalueToken6 = nestedvalue6.MoveTry3(context).ConfigureAwait(false);
                Assert.IsTrue(nestedvalueToken6.TryNull(out var nestednull));

                (context, var nestedsubsequentMembers5) = @nestednull.MoveTry2(context).ConfigureAwait(false);
                var nestedsubsequentMembersToken5 = nestedsubsequentMembers5.MoveTry3(context).ConfigureAwait(false);
                Assert.IsTrue(nestedsubsequentMembersToken5.TryNone(out var nestedsubsequentMember5));

                (context, var nestedobjectEnd) = nestedsubsequentMember5.MoveTry2(context).ConfigureAwait(false);
                subsequentMembers6 = nestedobjectEnd.MoveTry4(context).ConfigureAwait(false);
            }

            var subsequentMembersToken6 = subsequentMembers6.MoveTry3(context).ConfigureAwait(false);
            Assert.IsTrue(subsequentMembersToken6.TryMore(out var subsequentMember6));

            // emptyobject
            var comma6 = subsequentMember6.MoveTry1(context).ConfigureAwait(false);
            var whitespace21 = comma6.MoveTry4(context).ConfigureAwait(false);
            (context, var member7) = whitespace21.MoveTry2(context).ConfigureAwait(false);
            var string8 = member7.MoveTry1(context).ConfigureAwait(false);
            var stringDelimiter15 = string8.MoveTry1(context).ConfigureAwait(false);
            var chars8 = stringDelimiter15.MoveTry4(context).ConfigureAwait(false);
            (context, var stringDelimiter16) = chars8.MoveTry2(context).ConfigureAwait(false);
            var whitespace22 = stringDelimiter16.MoveTry4(context).ConfigureAwait(false);
            (context, var colon7) = whitespace22.MoveTry2(context).ConfigureAwait(false);
            var whitespace23 = colon7.MoveTry4(context).ConfigureAwait(false);
            (context, var value8) = whitespace23.MoveTry2(context).ConfigureAwait(false);
            var valueToken8 = value8.MoveTry3(context).ConfigureAwait(false);
            Assert.IsTrue(valueToken8.TryObject(out var object3));
            var objectStart3 = object3.MoveTry1(context).ConfigureAwait(false);
            var whitespace24 = objectStart3.MoveTry4(context).ConfigureAwait(false);
            (context, var members3) = whitespace24.MoveTry2(context).ConfigureAwait(false);
            var membersToken3 = members3.MoveTry3(context).ConfigureAwait(false);
            Assert.IsTrue(membersToken3.TryNone(out var whitespace25));
            (context, var objectEnd) = whitespace25.MoveTry2(context).ConfigureAwait(false);
            var subsequentMembers7 = objectEnd.MoveTry4(context).ConfigureAwait(false);
            var subsequentMembersToken7 = subsequentMembers7.MoveTry3(context).ConfigureAwait(false);
            Assert.IsTrue(subsequentMembersToken7.TryMore(out var subsequentMember8));

            // emptyarray
            var comma7 = subsequentMember8.MoveTry1(context).ConfigureAwait(false);
            var whitespace26 = comma7.MoveTry4(context).ConfigureAwait(false);
            (context, var member8) = whitespace26.MoveTry2(context).ConfigureAwait(false);
            var string9 = member8.MoveTry1(context).ConfigureAwait(false);
            var stringDelimiter17 = string9.MoveTry1(context).ConfigureAwait(false);
            var chars9 = stringDelimiter17.MoveTry4(context).ConfigureAwait(false);
            (context, var stringDelimiter18) = chars9.MoveTry2(context).ConfigureAwait(false);
            var whitespace27 = stringDelimiter18.MoveTry4(context).ConfigureAwait(false);
            (context, var colon8) = whitespace27.MoveTry2(context).ConfigureAwait(false);
            var whitespace28 = colon8.MoveTry4(context).ConfigureAwait(false);
            (context, var value9) = whitespace28.MoveTry2(context).ConfigureAwait(false);
            var valueToken9 = value9.MoveTry3(context).ConfigureAwait(false);
            Assert.IsTrue(valueToken9.TryArray(out var array));
            var arrayStart = array.MoveTry1(context).ConfigureAwait(false);
            var whitespace29 = arrayStart.MoveTry4(context).ConfigureAwait(false);
            (context, var arrayElements) = whitespace29.MoveTry2(context).ConfigureAwait(false);
            var arrayElementsToken = arrayElements.MoveTry3(context).ConfigureAwait(false);
            Assert.IsTrue(arrayElementsToken.TryNone(out var whitespace30));
            (context, var arrayEnd) = whitespace30.MoveTry2(context).ConfigureAwait(false);
            var subsequentMembers9 = arrayEnd.MoveTry4(context).ConfigureAwait(false);
            var subsequentMembersToken9 = subsequentMembers9.MoveTry3(context).ConfigureAwait(false);
            Assert.IsTrue(subsequentMembersToken9.TryMore(out var subsequentMember10));

            // array
            var comma8 = subsequentMember10.MoveTry1(context).ConfigureAwait(false);
            var whitespace31 = comma8.MoveTry4(context).ConfigureAwait(false);
            (context, var member9) = whitespace31.MoveTry2(context).ConfigureAwait(false);
            var string10 = member9.MoveTry1(context).ConfigureAwait(false);
            var stringDelimiter19 = string10.MoveTry1(context).ConfigureAwait(false);
            var chars10 = stringDelimiter19.MoveTry4(context).ConfigureAwait(false);
            (context, var stringDelimiter20) = chars10.MoveTry2(context).ConfigureAwait(false);
            var whitespace32 = stringDelimiter20.MoveTry4(context).ConfigureAwait(false);
            (context, var colon9) = whitespace32.MoveTry2(context).ConfigureAwait(false);
            var whitespace33 = colon9.MoveTry4(context).ConfigureAwait(false);
            (context, var value10) = whitespace33.MoveTry2(context).ConfigureAwait(false);
            var valueToken10 = value10.MoveTry3(context).ConfigureAwait(false);
            Assert.IsTrue(valueToken10.TryArray(out var array2));
            var arrayStart2 = array2.MoveTry1(context).ConfigureAwait(false);
            var whitespace34 = arrayStart2.MoveTry4(context).ConfigureAwait(false);
            (context, var arrayElements2) = whitespace34.MoveTry2(context).ConfigureAwait(false);
            var arrayElementsToken2 = arrayElements2.MoveTry3(context).ConfigureAwait(false);
            Assert.IsTrue(arrayElementsToken2.TrySome(out var arrayElement));
            var value11 = arrayElement.MoveTry1(context).ConfigureAwait(false);
            var valueToken11 = value11.MoveTry3(context).ConfigureAwait(false);
            Assert.IsTrue(valueToken11.TryObject(out var object4));
            var objectStart4 = object4.MoveTry1(context).ConfigureAwait(false);
            var whitespace35 = objectStart4.MoveTry4(context).ConfigureAwait(false);
            (context, var members4) = whitespace35.MoveTry2(context).ConfigureAwait(false);
            var membersToken4 = members4.MoveTry3(context).ConfigureAwait(false);
            ...
            {
                // true
                var nestedMember = firstMember4.MoveTry1(context).ConfigureAwait(false);
                var nestedString = nestedMember.MoveTry1(context).ConfigureAwait(false);
                var nestedStringDelimiter = nestedString.MoveTry1(context).ConfigureAwait(false);
                var nestedChars = nestedStringDelimiter.MoveTry4(context).ConfigureAwait(false);
                (context, var nestedStringDeliminter2) = nestedChars.MoveTry2(context).ConfigureAwait(false);
                ...
                (context, var nestedobjectEnd) = nestedsubsequentMember5.MoveTry2(context).ConfigureAwait(false);
                subsequentArrayElements = nestedobjectEnd.MoveTry4(context).ConfigureAwait(false);
            }

            var subsequentArrayElementsToken = subsequentArrayElements.MoveTry3(context).ConfigureAwait(false);
            Assert.IsTrue(subsequentArrayElementsToken.TryNone(out var whitespace36));
            (context, var arrayEnd2) = whitespace36.MoveTry2(context).ConfigureAwait(false);
            var subsequentMembers10 = arrayEnd2.MoveTry4(context).ConfigureAwait(false);
            var subsequentMembersToken10 = subsequentMembers10.MoveTry3(context).ConfigureAwait(false);
            Assert.IsTrue(subsequentMembersToken10.TryNone(out var whitespace37));
            (context, var objectEnd2) = whitespace37.MoveTry2(context).ConfigureAwait(false);
            var whitespace38 = objectEnd2.MoveTry4(context).ConfigureAwait(false);
            (context, var nothing) = whitespace38.MoveTry2(context).ConfigureAwait(false);
        ...
        public static async Task StaticOnly(Stream stream)
        {
            ...
            var valueToken6 = await value6.Move31(context).ConfigureAwait(false);
            Assert.IsTrue(valueToken6.TryNull(out var @null));
            (context, var subsequentMembers5) = await @null.Move2(context).ConfigureAwait(false);
            var subsequentMembersToken5 = await subsequentMembers5.Move31(context).ConfigureAwait(false);
            Assert.IsTrue(subsequentMembersToken5.TryMore(out var subsequentMember5));
            ...
            Json5.SubsequentMembersReader<Json5.WhitespaceReader<Json5.ObjectEndReader<Json5.WhitespaceReader<Nothing>>>> subsequentMembers6;
            {
                ...
                var nestedfracToken = await nestedfrac.Move31(context).ConfigureAwait(false);
                Assert.IsTrue(nestedfracToken.TryAbsent(out var nestedexp));
                var nestedexpToken = await nestedexp.Move31(context).ConfigureAwait(false);
                Assert.IsTrue(nestedexpToken.TryAbsent(out var nestedsubsequentMembers3));
                ...
                var nestedvalueToken6 = await nestedvalue6.Move31(context).ConfigureAwait(false);
                Assert.IsTrue(nestedvalueToken6.TryNull(out var nestednull));

                (context, var nestedsubsequentMembers5) = await @nestednull.Move2(context).ConfigureAwait(false);
                var nestedsubsequentMembersToken5 = await nestedsubsequentMembers5.Move31(context).ConfigureAwait(false);
                Assert.IsTrue(nestedsubsequentMembersToken5.TryNone(out var nestedsubsequentMember5));
            ...
            var valueToken8 = await value8.Move31(context).ConfigureAwait(false);
            Assert.IsTrue(valueToken8.TryObject(out var object3));
            ...
            var membersToken3 = await members3.Move31(context).ConfigureAwait(false);
            Assert.IsTrue(membersToken3.TryNone(out var whitespace25));
